...
$db_host 		= 	"mysql.cheny.com.br"; 	// MySQL Host Name.
$db_user 		= 	"cheny08"; 		// MySQL User Name.
$db_password 	= 	"cheny08"; 	// MySQL Password.
$db_name 		= 	"cheny08"; 			// MySQL Database Name.

// *** GENERAL DETAILS ***
// If you are not using your own login system, replace these with your Unity username and password.

$unityUsername = "cheny";				//This should match the webUsername set in Unity.
$unityPassword = "chenyrox"; //This should match the webPassword set in Unity.
